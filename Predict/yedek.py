    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                denemeImage = denemeImage.crop((left-100, top-100, right+100, bottom+100)) # frame i crop ettim
                denemeImage=np.asarray(denemeImage) #np.uint8() # Hata önlemek ve modele uygun veri hali
                
                gray = preProcess(denemeImage)
                #gray = denemeImage
